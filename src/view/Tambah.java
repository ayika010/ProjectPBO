...
public class Tambah extends JFrame {
     JLabel ljudul = new JLabel("Silahkan Input Data Sewa");
    ...
    public JButton bback = new JButton("Kembali");
     ...
     public Tambah(){
        ...
        ljudul.setBounds(220,15,200,30);
        ljudul.setFont(new Font("Calibri", Font.BOLD, 18));   
        
        lid.setBounds(160,60,170,30);
        fid.setBounds(270,60,170,30);
        lid.setFont(new Font("Calibri", Font.BOLD, 15));
        
        lnama.setBounds(160,100,170,30);
        fnama.setBounds(270,100,170,30);
        lnama.setFont(new Font("Calibri", Font.BOLD, 15));        

        ltipe.setBounds(160,140,170,30);
        ftipe.setBounds(270,140,170,30);
        ltipe.setFont(new Font("Calibri", Font.BOLD, 15));   
        
        lpinjam.setBounds(160,180,170,30);
        fpinjam.setBounds(270,180,170,30);
        lpinjam.setFont(new Font("Calibri", Font.BOLD, 15));  
        
        lkembali.setBounds(160,220,170,30);
        fkembali.setBounds(270,220,170,30);
        lkembali.setFont(new Font("Calibri", Font.BOLD, 15));   
        
        bsubmit.setBounds(420,300,90,20);
        breset.setBounds(520,300,90,20);
